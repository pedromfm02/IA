...
class Cidades(SearchDomain):
    ...
    #EX7 implementar a função que devolve o custo   
    ...
    def heuristic(self, city, goal_city):
       ...
       #x2 = self.coordinates[goal_city][0]
       #y2 = self.coordinates[goal_city][1]
...
for algo in ['depth','breadth','uniform','greedy','a*']:
    pass
p = SearchProblem(cidades_portugal,'Braga','Faro')
t = SearchTree(p,algo) # pesquisa em profundidade
print(t.search())
